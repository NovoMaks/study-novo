...
function Marq2() {
  const marquess = ["Узнать подробнее"]; // Replace with your actual array
  const AllMarquess = Array(6).fill(marquess).flat();
  const contact = ["Написать мне"]; // Replace with your actual array
    ...
    <section className="call-marq section-padding o-hidden">
      <div className="main-marq lrg sub-bg pt-20 pb-20">
        <div className="slide-har st1">
          ...
          <a target="_blank" href="https://t.me/novms" className="overlay-link"></a>
        </div>
      </div>

                ...
                <div className="cont">
                  ...
                  <div>
                    <p>
                      ...
                      <span className="main-color">пожеланий всех учеников</span>.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-5">
                <div className="cont">
                  ...
                  <div>
                    <p>
                      Моя основная цель - это найти искру любви к программированию, а после этого
                      познакомить ученика со всеми{" "}
                      <span className="main-color">этапами проектной деятельности</span>.
                      <br />
                ...
                <div className="cont">
                  ...
                  <div>
                    <p>
                      ...
                      ученик расскажет о своей работе и продемонстрирует ее. Это развивает привычку{" "}
